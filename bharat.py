...
sampler1 = ClusterCentroids()
sampler2 = TomekLinks(sampling_strategy='majority')
sampler3 = RandomUnderSampler(sampling_strategy='majority', random_state=12)
sampler4 = NearMiss()
sampler5 = ADASYN()


model1 = GradientBoostingClassifier(n_estimators=100, learning_rate=0.1, random_state=42)
